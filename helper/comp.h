...
extern bool comp_stream_to_stream(std::istream& istr, std::ostream& ostr, Compressor comp=COMP_AUTO);
extern bool comp_file_to_file(const char* pcFileIn, const char* pcFileOut, Compressor comp=COMP_GZ);
