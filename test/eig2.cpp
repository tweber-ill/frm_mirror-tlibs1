// gcc -I/usr/include/lapacke -o eig2 eig2.cpp ../math/linalg2.cpp ../helper/log.cpp -lstdc++ -lm -llapacke -llapack -std=c++11
...
int main()
{
	...
	for(int i=0; i<evals2.size(); ++i)
		std::cout << "eval: " << evals2[i] << ", evec: " << (evecs2[i]/ublas::norm_2(evecs2[i])) << std::endl;
	std::cout << std::endl;
