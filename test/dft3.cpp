// gcc -o dft3 dft3.cpp -lstdc++ -lm -std=c++11
...
int main()
{
	...
	tl::FFT<double> fourier(iSize);
	//tl::DFT<double> fourier(iSize);
	fourier.trafo(dInR, dInI, dOutR, dOutI, 0);
	...
	fourier.trafo(dOutR, dOutI, dInR, dInI, 1);
